...
[https://mvnrepository.com/](https://mvnrepository.com/) 가서 jsoup 치고 jar 파일 다운로드

file > project structure > Libraries > + > 다운받았던 파일 add.

[https://sum.su.or.kr:8888/bible/today](https://sum.su.or.kr:8888/bible/today) ← 여기서 웹 크롤링을 해보자
...
public class JsoupExample {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Bible Information Box: " + bibleInfoBox.text());
        System.out.println();
...
/*
Bible Text: 무죄한 피가 흐르지 않도록
Bible Information Box: 본문 : 신명기(Deuteronomy) 19:1 - 19:21 찬송가 586장
